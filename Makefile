...
wasm:
	emcc -fdiagnostics-color=always -g ./$(wildcard *.c) -o ./project.html --shell-file ./shell_minimal.html --js-library ./js_library.js -sEXPORTED_FUNCTIONS=_wasmMain,_main,_runNextIteration -sEXPORTED_RUNTIME_METHODS=cwrap
